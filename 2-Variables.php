...
// глобальную переменную в нутри функции нужно приписать global, то есть область видимости.
function test1(){
    global $team7;
    echo $team7;
...
// Фигурные скобки в данном случае используются для явного указания порядка операций. (Сначала возьми элемент массива, а уже потом создай перменную с именем = элементу массива)
